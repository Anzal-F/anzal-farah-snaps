...
export default function Navbar({ tags, selectedTag, handleFilterSelect, isOpen, toggleNavbar }) {
  return (
    <nav className={`navbar ${isOpen ? "expanded" : ""}`}>
      <div className="navbar-top">
        <a href="/" className="navbar-title">Snaps</a>
        <button
          className={`filter-button ${isOpen ? "active" : ""}`}
          onClick={toggleNavbar}  
        >
          Filter
          <svg className="filter-icon" width="15" height="11" viewBox="0 0 15 11" fill="none" xmlns="http://www.w3.org/2000/svg">
